...
#~ from venster.myole4ax import IOleInPlaceActiveObject, IOleInPlaceUIWindow
...
class Browser(AxWindow):#, dispinterface_EventReceiver):
    ...
    def __init__(self, url = "about:blank", *args, **kwargs):
        ...
        pOle = CreateObject("InternetExplorer.Application") #automation object
        ...
        self.pBrowser = mod.IWebBrowser2
        sink = EventSink()
        self.connectInfo = GetEvents(self.pOle, sink, self.pBrowser)
