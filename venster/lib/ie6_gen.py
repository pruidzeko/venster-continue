...
from ctypes import *
from comtypes import IUnknown, GUID, STDMETHOD, HRESULT, DISPMETHOD#, dispinterface
from comtypes.automation import IDispatch, BSTR, VARIANT, DISPPARAMS, EXCEPINFO
...
class DWebBrowserEvents(object):
...
class DShellNameSpaceEvents(object):
...
class _SearchAssistantEvents(object):
